  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (response.data.token) {
        ...
        localStorage.clear(); // Nettoyer l'ancienne session avant d'en démarrer une nouvelle
        ...
        localStorage.setItem('userName', decodedToken.sub || decodedToken.name || "Enseignant");
