...
const TeacherCourseSchedulePage: React.FC = () => {
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        <CardTitle>Emploi du Temps - Mes Cours</CardTitle>
      ...
      <CardContent>
        <Table>
          ...
          <TableBody>
            {teacherCourseSchedule.map((item, index) => (
              <TableRow key={index}>
...
export default TeacherCourseSchedulePage;
