...
const TeacherNotificationsPage: React.FC = () => {
  ...
  return (
    <TooltipProvider>
      <style>{`
        main:has(#teacher-notifications-area) { padding: 0 !important; overflow: hidden !important; }
        div:has(> #teacher-notifications-area).max-w-7xl { max-width: none !important; margin: 0 !important; width: 100% !important; }
      `}</style>

      <div id="teacher-notifications-area" className="flex flex-col h-[calc(100vh-4rem)] w-full bg-background overflow-hidden border-t border-border/50">
