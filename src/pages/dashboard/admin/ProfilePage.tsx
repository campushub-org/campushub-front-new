        ...
        <CardContent className="space-y-6">
          <div className="flex flex-col items-center sm:flex-row sm:items-start space-y-4 sm:space-y-0 sm:space-x-4">
            <div className="relative group">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center rounded-full opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer">
            ...
            <div className="text-center sm:text-left">
              ...
              <p className="text-md text-muted-foreground">Administrateur</p>
            </div>
          </div>
