...
import { LayoutDashboard, BookOpen, CalendarDays, Search, Bell, User } from 'lucide-react';
...
const studentNavItems: NavItem[] = [
  ...
  { to: '/dashboard/student/schedule-filter', icon: <Search size={20} />, label: 'Filtrage du planning par ressource' },
];
