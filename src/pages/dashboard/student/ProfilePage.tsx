...
interface UserProfile {
  ...
  studentNumber?: string; // Specific to Student
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
             ...
             <div className="space-y-2">
              ...
              <Input id="studentNumber" value={editableProfileData.studentNumber || ''} onChange={handleChange} readOnly={!isEditingProfile} />
            </div>
          </div>
        </CardContent>
      </Card>
